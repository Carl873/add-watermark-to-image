...
- Example 1
  ...
  - uses Windows
    ...
    ```
  ![example 1 original image](/examples/example1original.png)
  ![example 1 watermarked image](/examples/example1w.png)
...
- Example 5
  - set watermark relative size to 30%
    ...
    ```
    ![example 5 watermarked image](/examples/example5.png)
...
- Example 9
  - puts watermark in upper right corner
    ...
    -Gravity 'NorthEast'
    ```
    ![example 9 watermarked image](/examples/example9.png)
...
- Example 10
  - set watermark opacity to 30$
    ...
    ```
    ![example 10 watermarked image](/examples/example10.png)
